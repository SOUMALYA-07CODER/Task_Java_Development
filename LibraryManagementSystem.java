...
public class LibraryManagementSystem {
    public static void main(String[] args) {
        ...
        library.addBook(new Book("Taranath Tantrik", "Taradas Bandyopadhyay"));
        library.addBook(new Book("Bhoy", "Humayun Ahmed"));
        library.addBook(new Book("Bhootera Achhen Bhootera Thakben", "Prafulla Roy"));
